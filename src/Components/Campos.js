const general = [
    ...
    [1.4, "distribucion", "Distribución geográfica", "compuesto"],
    [1.5, "fenologia", "Fenología", "Compuesto"],
  ];

const plantaciones = [
  [2.1, "plantaciones_nacionales", "Plantaciones nacionales", "compuesto"],
  [2.2, "plantaciones_departamentales", "Plantaciones departamentales", "compuesto"]
];
...
const optima = [
  ...
  [5.3, "distribucion_altitudinal_optima", "Distribución altitudinal", "simple"],
...
const silvicultra = [
  ...
  [7.5, "edad_raleo", "Densidad del raleo", "simple"],
...
const madera = [
  ...
  [9.4, "precio_madera_dimensionada", "Precio de madera dimensionada", "simple"],
];
...
export { general, plantaciones, germoplasma, generales, optima, propagacion, silvicultra, crecimiento, madera, plagas, bibliografia };