...
const AgregarEspecie = () => {
  ...
  const calificar = (form, valores) => {
    ...
    const resultado = Object.values(valores).map((el, index) =>
      evaluacion[index] ? el : 0
    );
  ...
  return (
    <div style={{ width: "99%" }}>
      ...
      >
        <HiDocumentAdd
          style={{ width: "5vh", height: "45px", color: "orange" }}
        />
      ...
      <form ref={form} onSubmit={agregar} style={{ textAlign: "center" }}>
        ...
        >
          ...
          <Acordion
            titulo="Requerimientos ecológicos generales"
            contenido={generales}
          />
          <Acordion
            titulo="Requerimientos ecológicos óptimos"
            contenido={optima}
          />
          <Acordion titulo="Propagación" contenido={propagacion} />
          <Acordion titulo="Silvicultura" contenido={silvicultra} />
          <Acordion
            titulo="Crecimiento - Rendimientos"
